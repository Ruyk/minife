...
CudaELLMatrix {
  ...
  void copyToDevice() const {
    ...
    dpct::get_default_queue()
        .memcpy(const_cast<Scalar *>(dpct::get_raw_pointer(&d_coefs[0])),
                const_cast<Scalar *>(&coefs[0]), sizeof(Scalar) * n)
        .wait();
    cudaCheckError();
    dpct::get_default_queue()
        .memcpy(const_cast<GlobalOrdinal *>(dpct::get_raw_pointer(&d_cols[0])),
                const_cast<GlobalOrdinal *>(&cols[0]),
                sizeof(GlobalOrdinal) * n)
        .wait();
    cudaCheckError();
    dpct::get_default_queue()
        .memcpy(const_cast<GlobalOrdinal *>(dpct::get_raw_pointer(&d_rows[0])),
                const_cast<GlobalOrdinal *>(&rows[0]),
                sizeof(GlobalOrdinal) * rows.size())
        .wait();
    cudaCheckError();
  }
  void copyToHost() const {
    ...
    int n=d_coefs.size();
    dpct::get_default_queue()
        .memcpy(const_cast<Scalar *>(&coefs[0]),
                const_cast<Scalar *>(dpct::get_raw_pointer(&d_coefs[0])),
                sizeof(Scalar) * n)
        .wait();
    cudaCheckError();
    dpct::get_default_queue()
        .memcpy(const_cast<GlobalOrdinal *>(&cols[0]),
                const_cast<GlobalOrdinal *>(dpct::get_raw_pointer(&d_cols[0])),
                sizeof(GlobalOrdinal) * n)
        .wait();
    cudaCheckError();
    dpct::get_default_queue()
        .memcpy(const_cast<GlobalOrdinal *>(&rows[0]),
