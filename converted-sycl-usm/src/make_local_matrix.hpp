...
#define CUDA_MAKE_LOCAL
  ...
  */
  ...
  dpct::get_default_queue()
      .memcpy(&external_index[0], dpct::get_raw_pointer(&d_map.table[1]),
              num_external * sizeof(GlobalOrdinal))
      .wait();
  cudaCheckError();
#else
...
#pragma omp critical 
{
  ...
  */
  ...
  CudaManager::s1->memcpy(dpct::get_raw_pointer(&A.d_elements_to_send[0]),
