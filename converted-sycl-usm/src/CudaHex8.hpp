...
namespace miniFE {
  ...
  namespace Hex8 {
    ...
    dpct::constant_memory<MINIFE_SCALAR, 1> gauss_pts_c(numGaussPointsPerDim);
...
#pragma unroll
        for(size_t i=0; i<numNodesPerElem; ++i) {
          ...
          /*
          DPCT1026:38: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals0 = *(gradients + texidx + 0);
          /*
          DPCT1026:39: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals1 = *(gradients + texidx + 1);
          /*
          DPCT1026:40: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals2 = *(gradients + texidx + 2);
...
#pragma unroll
        for(int j=0; j<numNodesPerElem; ++j) {
          ...
          /*
          DPCT1026:41: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          Scalar gv0 = *(gradients + texidx + 0);
          /*
          DPCT1026:42: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          Scalar gv1 = *(gradients + texidx + 1);
          /*
          DPCT1026:43: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          Scalar gv2 = *(gradients + texidx + 2);
    ...
    template<typename Scalar>
      __inline__ void compute_detJ(int elethidx, const Scalar elemNodeCoords[Hex8::spatialDim],
          Scalar& detJ, const Scalar *gradients)
      {
        Scalar J0=0,J1=0,J2=0,J3=0,J4=0,J5=0,J6=0,J7=0,J8=0;
        Scalar grad_vals0, grad_vals1, grad_vals2;
...
#pragma unroll
        for(size_t i=0; i<Hex8::numNodesPerElem; ++i) {
          ...
          /*
          DPCT1026:44: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals0 = *(gradients + texidx + 0);
          /*
          DPCT1026:45: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals1 = *(gradients + texidx + 1);
          /*
          DPCT1026:46: The call to __ldg was removed because there is no
          correspoinding API in DPC++.
          */
          grad_vals2 = *(gradients + texidx + 2);
    ...
    template<typename Scalar>
      __inline__ void diffusion_matrix_device(Scalar elem_mat[Hex8::numNodesPerElem*(Hex8::numNodesPerElem+1)/2], Scalar invJ_grad_vals[numNodesPerElem*spatialDim], Scalar k_detJ_wi_wj_wk)
      {
        int offset = 0;
#pragma unroll
...
#pragma unroll
    ...
    template<typename Scalar>
      __inline__ void diffusionMatrix_symm(const Scalar elemNodeCoords[Hex8::spatialDim],
    ...
    template<typename Scalar>
      __inline__ void sourceVector(const Scalar elemNodeCoords[Hex8::spatialDim],
...
#pragma unroll
              for(int i=0; i<numNodesPerElem; ++i) {
                /*
                DPCT1026:47: The call to __ldg was removed because there is no
                correspoinding API in DPC++.
                */
                psii = *(psi + elethidx * numNodesPerElem + i);
