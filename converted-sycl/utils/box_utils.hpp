...
#endif
    void
    get_int_coords(GlobalOrdinal ID, int nx, int ny, int nz, int &x, int &y,
                   int &z)
{
  z = ID/(nx*ny);
  y = (ID%(nx*ny))/nx;
...
#endif
    void
    get_coords(GlobalOrdinal ID, int nx, int ny, int nz, Scalar &x, Scalar &y,
               Scalar &z)
{
...
#endif
    GlobalOrdinal
    get_id(int nx, int ny, int nz, int x, int y, int z)
{
